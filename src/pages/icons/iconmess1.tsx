...
function IconMess1() {
  return (
    <svg
      ...
      x="0"
      y="0"
      className="x1lliihq x1k90msu x13hzchw x1qfuztq xsrhx6k"
      viewBox="0 0 17 16"
    >
      <g fillRule="evenodd">
        <circle cx="5.5" cy="5.5" r="1" fill="none"></circle>
        <circle cx="11.5" cy="4.5" r="1" fill="none"></circle>
        <path
          fill="none"
